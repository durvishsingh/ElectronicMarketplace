...
import application.Company_Home_Page_Panels.inventory;
...
public class Root_Home_Page_Panels extends Application 
{
	...
	public Root_Home_Page_Panels(String a, String b, String c) 
	{
		// TODO Auto-generated constructor stub
		Root_Home_Page_Panels.id = a;
		Root_Home_Page_Panels.user = b;
		Root_Home_Page_Panels.pass = c;
...
//					}
	...
	public static VBox QueryPanel()
	{
		try
		{
	        ...
	        query1.setText("Insert a new mobile");
	        query1.setId("LoginButton");
	        query1.setMinWidth(800);

			Button query2 = new Button();
			query2.setText("update the price of mobiles by giving a 40% discount");
			query2.setId("LoginButton");
			query2.setMinWidth(800);
			
			Button query3 = new Button();
			query3.setText("Order the list of suppliers on the basis of their rating and reviews");
			query3.setId("LoginButton");
			query3.setMinWidth(800);
			
			Button query4 = new Button();
			query4.setText("List the highest rated supplier that supplies the Mobile phones");
			query4.setId("LoginButton");
			query4.setMinWidth(800);
	        
	        Button query5 = new Button();
	        query5.setText("List all the Mobile from Samsung");
...
//	        grid.add(clear, 0, 5);
				...
				try
	  			{
					result_textfield.setText("");
	  				Connection con=DriverManager.getConnection("jdbc:Mysql://127.0.0.1:3306/store","root","9153");
					Statement stmt=con.createStatement();
					String query = "Insert into product_type(product_name, price, brand_name, type_1, colour, rating , supplier_id) values ('Iphone XR', 90000, 'Apple', 'Smart Phone', 'Black', 4.0, 1);";
					stmt.executeUpdate(query);
					query = "Insert into mobiles(product_id,os,primary_camera,processor,screen_size,battery,ram) values ((select product_id from product_type where product_name = 'Iphone XR' and supplier_id = 1 and colour = 'Black'), 'IOS', '12mp 3x Camera', 'A13 bionic chip', '5.0 inch', '3100 mah', '4GB');";
					stmt.executeUpdate(query);
					query = "Insert into inventory values ((select product_id from product_type where product_name = 'Iphone XR' and supplier_id = 1 and colour = 'Black'), 0, 1);";
					stmt.executeUpdate(query);
				...
				try
	  			{
					result_textfield.setText("");
	  				Connection con=DriverManager.getConnection("jdbc:Mysql://127.0.0.1:3306/store","root","9153");
					Statement stmt=con.createStatement();
					String query = "Update product_type set price = price* 0.6 where type_1 = 'Smart Phone';";
					stmt.executeUpdate(query);
					updatequerysucess.showAndWait();
					con.close();
	  			}
				...
				try
	  			{
					result_textfield.setText("");
	  				Connection con=DriverManager.getConnection("jdbc:Mysql://127.0.0.1:3306/store","root","9153");
					Statement stmt=con.createStatement();
					String query = "select supplier_id, username, rating from Account_Supplier order by rating;";
					ResultSet rs = stmt.executeQuery(query);
				...
				try
	  			{
					result_textfield.setText("");
	  				Connection con=DriverManager.getConnection("jdbc:Mysql://127.0.0.1:3306/store","root","9153");
					Statement stmt=con.createStatement();
					String query = "select Account_Supplier.supplier_id, username, Account_Supplier.rating from Account_Supplier inner join product_type on Account_Supplier.supplier_id = product_type.supplier_id where product_type.type_1='mobiles' and Account_Supplier.rating = (select max(Account_Supplier.rating) from Account_Supplier inner join product_type on Account_Supplier.supplier_id = product_type.supplier_id where product_type.type_1='mobiles');";
					ResultSet rs = stmt.executeQuery(query);
					ResultSetMetaData rsmd = rs.getMetaData();
					int n = rs.getMetaData().getColumnCount();
					for(int i =0;i<n;i++)
	...
	public static VBox HomePanel()
	{
		try
		{
			int sid = Integer.parseInt(Root_Home_Page_Panels.id);
			String info = "Hello Admin\n Encryption Algorithm : MD5 \n Salt : 123+PASSWORD+123";
			
			String temp_user = Root_Home_Page_Panels.user;
			String temp_pass = Root_Home_Page_Panels.pass;
...
//	        password.setText("Password");
	...
	public static VBox PasswordUpdatePanel()
	{
		try
		{
	        ...
	        submit.setOnAction(e -> 
			{
				if(oldpassword_textfield.getText().equals(Root_Home_Page_Panels.pass) && newpassword_textfield.getText().equals(renewpassword_textfield.getText()))
				{
					try
					{
						Connection con=DriverManager.getConnection("jdbc:Mysql://127.0.0.1:3306/store","root","9153");
						Statement stmt=con.createStatement();
						String query = "update Account_Supplier set password = \""+newpassword_textfield.getText()+"\" where supplier_id = \""+Root_Home_Page_Panels.id+"\"";
						Root_Home_Page_Panels.pass = newpassword_textfield.getText();
						stmt.executeUpdate(query);
						con.close();
						success.showAndWait();
					}
...
//						System.out.println(sid+" "+Long.parseLong(rs.getString(2))+" "+Long.parseLong(rs.getString(3))+" "+Integer.parseInt(rs.getString(4))+" "+rs.getString(5)+" "+customer_name.get(i));
	...
	public static VBox CheckOutPanel()
	{
		try
		{
			...
			try
  			{
				int cid = Integer.parseInt(Root_Home_Page_Panels.id);
  				Connection con=DriverManager.getConnection("jdbc:Mysql://127.0.0.1:3306/store","root","9153");
				Statement stmt=con.createStatement();
	        ...
	        empty.setOnAction(e ->
    		{
    			...
    			try
	  			{
					int a = Integer.parseInt(Root_Home_Page_Panels.id);
	  				Connection con=DriverManager.getConnection("jdbc:Mysql://127.0.0.1:3306/store","root","9153");
					Statement stmt=con.createStatement();
	        ...
	        confirm.setOnAction(e ->
    		{
    			...
    			if(choice.equals("OK"))
    			{
    				int customerid = Integer.parseInt(Root_Home_Page_Panels.id);
	  		...
	  		{	
				...
				ObservableList<order> final_list = FXCollections.observableArrayList();
	  			...
	  			try
	  			{
					...
					for(int i=0;i<list.size();i++)
					{
						int aid = Integer.parseInt(Root_Home_Page_Panels.id);
	...
	public static void EncryptPanel()
	{
        ...
        success.setHeaderText(null);
        success.setContentText("Passwords Encrypted");
        success.initStyle(StageStyle.UNDECORATED);
        ...
        try
		{
			Connection con=DriverManager.getConnection("jdbc:Mysql://127.0.0.1:3306/store","root","9153");
			Statement stmt=con.createStatement();
			String query = "select customer_id,password from Account_User";
			ResultSet rs = stmt.executeQuery(query);
			while(rs.next())
			{
...
//        {
//        	System.out.println("update Account_User set password = \'"+pass.get(i)+"\' where customer_id = "+id.get(i)+";");
//        }
...
//		System.out.println(pass);
		try
		{
			...
			{
				long a = id.get(i);
				String b = "123"+pass.get(i)+"123";
				b = encryption(b);
//				System.out.println(b);
				String query = "update Account_User set password = \'"+b+"\' where customer_id = "+a+";";
				stmt.executeUpdate(query);
			}
		}
		catch(Exception err)
		...
		try
		{
			Connection con=DriverManager.getConnection("jdbc:Mysql://127.0.0.1:3306/store","root","9153");
			Statement stmt=con.createStatement();
			String query = "select supplier_id,password from Account_Supplier";
			ResultSet rs = stmt.executeQuery(query);
			while(rs.next())
			{
				id.add(Long.parseLong(rs.getString(1)));
...
//		for(int i=0;i<id.size();i++)
//        {
//        	System.out.println("update Account_Supplier set password = \'"+pass.get(i)+"\' where supplier_id = "+id.get(i)+";");
//        }
		try
		{
			Connection con=DriverManager.getConnection("jdbc:Mysql://127.0.0.1:3306/store","root","9153");
			...
			for(int i = 0;i<n;i++)
			{
				...
				b = encryption(b);
//				System.out.println(b);
				String query = "update Account_Supplier set password = \'"+b+"\' where supplier_id = "+a+";";
				stmt.executeUpdate(query);
			}
		}
		catch(Exception err)
...
//		
		try
		{
			Connection con=DriverManager.getConnection("jdbc:Mysql://127.0.0.1:3306/store","root","9153");
			Statement stmt=con.createStatement();
			String query = "select company_id,password from Account_Company";
			ResultSet rs = stmt.executeQuery(query);
			while(rs.next())
			{
				id.add(Long.parseLong(rs.getString(1)));
...
//		for(int i=0;i<id.size();i++)
//        {
//        	System.out.println("update Account_Company set password = \'"+pass.get(i)+"\' where company_id = "+id.get(i)+";");
//        }
		try
		{
			Connection con=DriverManager.getConnection("jdbc:Mysql://127.0.0.1:3306/store","root","9153");
			...
			for(int i = 0;i<n;i++)
			{
				...
				b = encryption(b);
//				System.out.println(b);
				String query = "update Account_Company set password = \'"+b+"\' where company_id = "+a+";";
				stmt.executeUpdate(query);
			}
		}
		catch(Exception err)
