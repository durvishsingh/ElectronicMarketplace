...
public class NewSupplier extends Application 
{
      	...
      	login.setOnAction(e -> 
        {
    		...
    		{ 
        		...
        		if(pass.equals(repass))
        		{
        			...
        			String query = "INSERT INTO Account_Supplier (username,password,rating) VALUES (\'"+user+"\',\'"+pass+"\',"+5.0+");";
        	...
        	try
    		{
        		Connection con=DriverManager.getConnection("jdbc:Mysql://127.0.0.1:3306/store","root","9153");
    			Statement stmt=con.createStatement();
    			String query = "SELECT supplier_id from account_supplier where username = \'"+user+"\';";
    			ResultSet rs = stmt.executeQuery(query);
    			rs.next();
    			System.out.println(rs.getString(1));
    			supplier_id = Long.parseLong(rs.getString(1));
    			con.close();
    		}
    		catch(Exception ee)
    		{ 
    		...
    		{ 
    			...
    			String query = "INSERT INTO Contact (phone_number,email,locality,pincode,city,state,country,customer_id,supplier_id) VALUES"
    					+ " ("+phone+",\'"+email+"\',\'"+add+"\',"+pin+",\'"+stt+"\',\'"+cty+"\',\'"+cntry+"\',"+null+","+supplier_id+");";
    			stmt.executeUpdate(query);
    			con.close();
    		}
    		catch(Exception ee)
