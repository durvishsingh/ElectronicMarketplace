...
insert into product_type(product_name, price, brand_name, type_1, colour, rating , supplier_id)
values ('Iphone XS', 90000, 'Apple', 'mobile', 'Black', 4, 26);
insert into mobiles
values ((select product_id from product_type
where product_name = 'Iphone XS' and supplier_id = 26 and colour = 'Black'), 'ios', '12mp triple camera setup', 'A13 bionic chip', '5.5 inch', '3100 mah', '4GB');
insert into inventory
values ((select product_id from product_type
where product_name = 'Iphone XS' and supplier_id = 26 and colour = 'Black'), 0, 26);
